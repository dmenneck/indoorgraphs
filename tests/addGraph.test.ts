...
describe('addGraph()', () => {
    const data1: any = {
        "nodes": {
            "EG_t1":[[6.941107327625539,50.94804643242088],"EG_t1",null,"EG","40c2",["EG_t2:d650"]],
            "EG_t2":[[6.946257168934133,50.949830888475304],"EG_t2",null,"EG","40c2",["EG_t1:d650"]]
        },
        "pa":{
    ...
    const data2: any = {
        "nodes": {
            "EG_t3":[[6.93934779851177,50.94753271267544],"EG_t3",null,"EG","eac3",["EG_t4:0675"]],
            "EG_t4":[[6.946772153064991,50.949452373218605],"EG_t4",null,"EG","a64b",["EG_t3:0675"]]
        },
    ...
    test("Should successfully combine node attributes", () => {
        ...
        Object.entries(graph.data.nodes).map(([key, values]: any) => {
            const nodeAttributesID = values[4];
